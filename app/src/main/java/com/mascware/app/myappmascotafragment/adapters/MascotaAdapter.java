...
public class MascotaAdapter extends  RecyclerView.Adapter<MascotaAdapter.MascotaViewHolder> {
    ...
    public MascotaAdapter(ArrayList<Mascota> mascotas, FragmentActivity activityw){
        ...
        /*holder.huesoB.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(mascota.isLike()==false){
                    ...
                    holder.raiting.setText(Integer.toString(Integer.parseInt(mascota.getRaiting())+1));
